...
if(fs.existsSync(pathToManifest)) {
    ...
    console.log('HOOK (appBeforePrepare): Set android:windowSoftInputMode to adjustPan');
}
else {
    console.log('HOOK (appBeforePrepare): Could not find AndroidManifest to set android:windowSoftInputMode');
}